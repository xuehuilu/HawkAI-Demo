...
import type { Repository, Scenario } from '../types';
                ...
                return (
                    <div className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="p-3 border-2 rounded-lg text-center border-indigo-500 bg-indigo-50">
                                <div className="text-3xl mb-1">🛡️</div>
                                <div className="font-bold text-sm text-slate-800">代码可靠性专家</div>
                            </div>
                        </div>
                    </div>
                );
